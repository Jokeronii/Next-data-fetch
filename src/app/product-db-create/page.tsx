      ...
      <form action={formAction} className="flex flex-col gap-4 p-4 bg-gray-800 rounded-lg shadow-md w-1/3 mx-auto mt-10">
        <div>
          <label className="text-white">
            Title
            <input type="text" name="title" className="border border-gray-300 rounded-lg p-2 w-full mb-4" placeholder="Enter product title" />
          </label>
        ...
        <div>
          <label className="text-white">
            Price
            <input type="number" name="price" className="border border-gray-300 rounded-lg p-2 w-full mb-4" placeholder="Enter product price" />
          </label>
        ...
        <div>
          <label className="text-white">
            Descriptions
            <input type="string" name="description" className="border border-gray-300 rounded-lg p-2 w-full mb-4" placeholder="Enter product decription" />
          </label>
